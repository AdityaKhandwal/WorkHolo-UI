...
export default function IOSAppDevelopment() {
  return (
    <div className="min-h-screen bg-white">
      {/* Top Bar */}
      <div className="bg-[#050505] border-b border-white/10 py-2 hidden md:block">
        <div className="max-w-[1440px] mx-auto px-6 flex items-center justify-between text-xs font-medium text-white/60">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <Mail size={14} className="text-[#0096FF]" />
              <span>contact@mtouchlabs.com</span>
            </div>
            <div className="flex items-center gap-2">
              <Phone size={14} className="text-[#0096FF]" />
          ...
          <div className="flex items-center gap-6">
            <span className="text-[#F2A900] font-bold">NASSCOM <span className="text-white/60 font-medium">SME Inspire Awards 2026 🏆</span></span>
