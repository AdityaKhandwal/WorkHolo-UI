...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-[#05070a]/90 backdrop-blur-md py-3 shadow-lg' : 'bg-transparent py-5'}`}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="flex items-center">
            <span className="text-2xl font-extrabold tracking-tighter flex items-center">
              <span className="text-white">mTouch</span>
              <span className="text-white ml-1">Labs</span>
            </span>
            <div className="ml-2 bg-white/10 p-1 rounded-full border border-white/20">
              <div className="w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center text-[8px] font-bold text-black">ISO</div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-8">
          {navLinks.map((link) => (
            <div key={link.name} className="group relative flex items-center gap-1 cursor-pointer">
              <span className="text-sm font-medium text-gray-300 group-hover:text-amber-500 transition-colors">
                {link.name}
              </span>
              {link.hasDropdown && <ChevronDown className="w-4 h-4 text-gray-400 group-hover:text-amber-500 transition-colors" />}
            </div>
          ))}
          <button className="bg-sky-500 hover:bg-sky-600 text-white px-6 py-2.5 rounded-full text-sm font-semibold flex items-center gap-2 transition-all transform hover:scale-105">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-4 py-6 flex flex-col gap-4">
              {navLinks.map((link) => (
                <div key={link.name} className="flex items-center justify-between py-2 border-b border-white/5">
                  <span className="text-lg font-medium text-gray-200">{link.name}</span>
                  {link.hasDropdown && <ChevronDown className="w-5 h-5 text-gray-400" />}
                </div>
              ))}
              <button className="mt-4 bg-sky-500 text-white w-full py-3 rounded-xl font-semibold flex items-center justify-center gap-2">
...
const TopBar = () => (
  <div className="bg-black py-2 border-b border-white/5 hidden md:block">
    <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between text-[11px] text-gray-400 font-medium">
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2">
          <span className="text-amber-500 font-bold">NASSCOM</span>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-4 gap-16 mb-24">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-8">
              <span className="text-2xl font-extrabold tracking-tighter">mTouch Labs</span>
              <div className="bg-white/10 p-1 rounded-full border border-white/20">
                <div className="w-5 h-5 bg-amber-500 rounded-full flex items-center justify-center text-[6px] font-bold text-black">ISO</div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {[Linkedin, Twitter, Facebook, Instagram, Youtube].map((Icon, i) => (
                <div key={i} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-sky-500 hover:text-white transition-all cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500 text-sm font-medium">
              <li className="hover:text-amber-500 cursor-pointer transition-colors">Custom Software Development</li>
              <li className="hover:text-amber-500 cursor-pointer transition-colors">Cloud & DevOps Solutions</li>
              <li className="hover:text-amber-500 cursor-pointer transition-colors">Mobile Application Development</li>
              <li className="hover:text-amber-500 cursor-pointer transition-colors">Quality Assurance & Testing</li>
              <li className="hover:text-amber-500 cursor-pointer transition-colors">AI & Data Analytics</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-500 text-sm">
              ...
              <button className="bg-sky-500 text-white w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-sky-600 transition-colors">
        ...
        <div className="border-t border-white/5 pt-16 mb-16">
          <div className="flex items-center gap-3 mb-12">
            ...
            <h4 className="text-white font-bold text-lg">Global Presence</h4>
          </div>
            ...
            {presence.map((p, i) => (
              <div key={i}>
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h5 className="text-sky-500 font-bold text-[10px] tracking-widest uppercase">{p.region}</h5>
                </div>
