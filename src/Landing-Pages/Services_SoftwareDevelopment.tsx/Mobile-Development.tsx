    ...
    <section className="py-24 bg-[#05070a] relative overflow-hidden">
      <div className="container-custom text-center relative z-10">
        <h2 className="text-4xl md:text-6xl font-bold mb-8">
          Ready to Build Your <span className="text-[#f39c12]">Mobile App</span>?
        </h2>
        <p className="text-gray-400 text-xl max-w-3xl mx-auto mb-12">
          Let's discuss how we can build a mobile solution that drives real business growth.
        </p>
        <button className="bg-[#f39c12] hover:bg-[#e67e22] text-white px-10 py-4 rounded-lg font-bold text-xl transition-all shadow-xl shadow-[#f39c12]/20">
          Start Your Project
        </button>
      </div>
      
      {/* Background Glow */}
      <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-[#00a8ff]/10 rounded-full blur-[100px]"></div>
      <div className="absolute -top-20 -left-20 w-96 h-96 bg-[#f39c12]/5 rounded-full blur-[100px]"></div>
    </section>
  );
};
...
const GlobalPresence = () => {
  ...
  return (
    <section className="py-20 bg-[#05070a] border-t border-white/5">
      <div className="container-custom">

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12">
          {regions.map((region) => (
            <div key={region.name}>
              <h4 className="text-[#00a8ff] text-[12px] font-bold tracking-widest mb-6 flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-[#00a8ff] rounded-full"></span> {region.name}
              </h4>
