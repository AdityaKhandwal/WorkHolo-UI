...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-dark-main/95 backdrop-blur-md py-3 shadow-lg' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-display font-bold text-2xl tracking-tight">mTouch Labs</span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-8">
          {navLinks.map((link) => (
            <a 
              key={link.name} 
              href={link.href} 
              className="text-white hover:text-accent font-medium text-[15px] flex items-center gap-1 transition-colors"
            >
              {link.name}
              {link.hasDropdown && <ChevronDown size={14} />}
            </a>
          ))}
          <button className="bg-[#00A3FF] hover:bg-[#0086D1] text-white px-6 py-2.5 rounded-full font-semibold text-[15px] flex items-center gap-2 transition-all shadow-lg">
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            ...
            className="lg:hidden bg-dark-main border-t border-white/10 overflow-hidden"
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <button className="bg-[#00A3FF] text-white px-6 py-3 rounded-full font-semibold text-center mt-4">
                Request Quote
              </button>
            </div>
          </motion.div>
...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-main text-white pt-24 pb-12">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-4 gap-12 mb-20">
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 leading-relaxed mb-8">
              A global technology partner engineering next-generation digital solutions that drive business growth and innovation.
            </p>
            <div className="flex gap-4">
              {[Linkedin, Twitter, Facebook, Instagram, Youtube].map((Icon, idx) => (
                <a key={idx} href="#" className="w-10 h-10 bg-white/5 hover:bg-accent rounded-full flex items-center justify-center transition-all">
                  <Icon size={18} />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              <li><a href="#" className="hover:text-accent transition-colors">Custom Software Development</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Mobile Application Development</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Salesforce Consulting</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Quality Assurance & Testing</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">AI & Data Analytics</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-8">
              <button className="w-full bg-[#00A3FF] hover:bg-[#0086D1] text-white px-6 py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all">
        ...
        <div className="border-t border-white/10 pt-16 mb-12">
          <div className="flex items-center gap-3 mb-12">
            ...
            <h3 className="text-2xl font-display font-bold">Global Presence</h3>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12">
            {regions.map((region) => (
              <div key={region.name}>
                <h5 className="text-accent font-bold text-sm tracking-widest mb-6 flex items-center gap-2">
        ...
        <div className="border-t border-white/10 pt-12 flex flex-col md:row items-center justify-between gap-6 text-white/40 text-sm">
          <p>© 2026 mTouch Labs. All Rights Reserved.</p>
      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-4">
        ...
        <button 
          ...
          className="w-14 h-14 bg-white text-dark-main rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform"
        >
          <ArrowUp size={32} />
        </button>
      </div>
