...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-orange-500 selection:text-white">
      ...
      {/* Top Bar */}
      <div className="bg-black text-white py-2 px-4 md:px-12 flex flex-col md:flex-row justify-between items-center text-[13px] border-b border-white/10">
        <div className="flex items-center gap-6">
          <a href="mailto:contact@mtouchlabs.com" className="flex items-center gap-2 hover:text-orange-500 transition-colors">
            <Mail className="w-4 h-4 text-orange-500" /> contact@mtouchlabs.com
          </a>
          <a href="tel:+919390683154" className="flex items-center gap-2 hover:text-orange-500 transition-colors">
            <Phone className="w-4 h-4 text-orange-500" /> +91 9390683154
          </a>
          <a href="tel:+15512220070" className="flex items-center gap-2 hover:text-orange-500 transition-colors">
            <Globe className="w-4 h-4 text-orange-500" /> +1 (551) 222-0070
          </a>
        </div>
        <div className="flex items-center gap-6 mt-2 md:mt-0">
          <span className="text-orange-500 font-bold uppercase tracking-wider">NASSCOM</span>
      ...
      {/* Navbar */}
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-black/95 backdrop-blur-md py-3' : 'bg-black py-5'} px-4 md:px-12 flex items-center justify-between`}>
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-white/50 uppercase tracking-[0.2em] -mt-1">Certified Company</span>
          </div>
        </div>
        ...
        <div className="hidden xl:flex items-center gap-8">
          {NAV_ITEMS.map((item) => (
            <a 
              key={item.label} 
              href={item.href} 
              className="text-white text-[15px] font-medium hover:text-orange-500 transition-colors flex items-center gap-1"
            >
              {item.label}
        ...
        <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2.5 rounded-full font-bold text-[15px] flex items-center gap-2 transition-all group">
          Request Quote
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              { icon: <Navigation className="w-8 h-8 text-gray-400" />, title: 'Interactive Navigation' },
      ...
      {/* Footer */}
      <footer className="bg-[#050505] pt-24 pb-12 px-4 md:px-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-4 gap-16 mb-24">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-8">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] text-white/50 uppercase tracking-[0.2em] -mt-1">Certified Company</span>
                </div>
              </div>
              <p className="text-white/50 leading-relaxed max-w-md mb-8">
                A global technology partner engineering immersive digital experiences. We help brands bridge the gap between physical spaces and digital audiences.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Home', 'About Us', 'Portfolio', 'Careers', 'Contact Us'].map((link) => (
                  <li key={link}><a href="#" className="text-white/50 hover:text-orange-500 transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Custom Software Development', 'Mobile App Development', 'Web Development', 'UI/UX Design', 'Digital Marketing'].map((link) => (
                  <li key={link}><a href="#" className="text-white/50 hover:text-orange-500 transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
          ...
          <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-white/30 text-sm">
              © 2026 <span className="text-white/60 font-bold">mTouch Labs Pvt. Ltd.</span> All rights reserved.
            </p>
