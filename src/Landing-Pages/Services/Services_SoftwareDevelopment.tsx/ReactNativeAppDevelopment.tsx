  ...
  return (
    <section className="relative pt-48 pb-32 px-4 md:px-12 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="text-white/60 text-sm font-bold uppercase tracking-[0.2em]">
              Home
            </span>
          ...
          <p className="text-lg text-white/60 max-w-3xl mx-auto mb-12 leading-relaxed">
            ...
            architecture, enabling rapid development while maintaining
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <a
          href="#"
          className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform"
        >
          <svg
            viewBox="0 0 24 24"
  ...
  const features = [
    {
      ...
      icon: <Layers className="text-[#00a8ff]" />,
      desc: "Modular UI structures for faster iteration and easier maintenance.",
    },
    {
      title: "Cross-Platform Codebase",
      icon: <Globe className="text-[#00a8ff]" />,
      desc: "Single codebase for iOS and Android, reducing development time by 40%.",
    },
    {
      title: "Near-Native Performance",
      icon: <Zap className="text-[#00a8ff]" />,
      desc: "Optimized runtime performance that bridges the gap with native apps.",
    },
    {
      title: "Rapid Deployment",
      icon: <Smartphone className="text-[#00a8ff]" />,
      desc: "Faster time-to-market with hot reloading and efficient workflows.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            ...
            using a shared JavaScript codebase that runs on both iOS and Android
            platforms while utilizing native device capabilities. It bridges
            flexibility with native device functionality.
          </p>
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            A professional React Native development company ensures
            cross-platform compatibility, native module integration, reusable UI
            components, and optimized runtime performance. Our{" "}
            <span className="text-[#00a8ff] font-bold">
              mobile app development expertise
            </span>{" "}
            ensures every React Native solution is built for real-world
            scalability.
          </p>
          <p className="text-lg text-gray-600 leading-relaxed">
            Combined with our{" "}
            <span className="text-[#00a8ff] font-bold underline">
              UI/UX design capabilities
            </span>
            , we deliver apps that are not only performant but also intuitive
            and user-friendly across both platforms.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        <div className="grid grid-cols-2 gap-6 order-2 lg:order-1">
          {stats.map((s, i) => (
            <div
              key={i}
              className="bg-white p-10 rounded-3xl shadow-xl shadow-gray-200/50 text-center border border-gray-100"
            >
              <div className="text-5xl font-black text-[#00a8ff] mb-2">
                {s.value}
              </div>
...
const ServicesSection = () => {
  const services = [
    {
      id: "01",
      title: "Custom React Native Apps",
      desc: "Tailored applications including startup MVPs, customer-facing platforms, internal enterprise mobility apps, subscription-based applications, and marketplace solutions — each engineered with modular architecture for scalability.",
    },
    {
      id: "02",
      title: "Hybrid Architecture Engineering",
      desc: "Unlike purely web-based hybrid apps, our React Native solutions enable native API access, smooth animations, real-time interactions, and hardware feature integration with stable performance under user growth.",
    },
    {
      id: "03",
      title: "UI Component Optimization",
      desc: "Modular UI structures, platform-adaptive layouts, performance-optimized navigation systems, and clean responsive visual elements enabling faster iteration and easier maintenance.",
    },
    {
      id: "04",
      title: "Backend & API Integration",
      desc: "Seamless connection with RESTful APIs, GraphQL endpoints, cloud services, payment systems, and authentication frameworks ensuring secure and scalable data handling.",
    },
    {
      id: "05",
      title: "Code Reusability & Maintenance Strategy",
      desc: "We structure projects to maximize shared code, minimize duplication, simplify future updates, improve testing workflows, and reduce long-term maintenance cost. Sustainable development is part of our architecture planning from day one.",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((s, i) => (
            ...
            >
              ...
              <h3 className="text-2xl font-black text-[#0a0a0a] mb-6">
                {s.title}
              </h3>
    ...
    <section className="py-24 px-4 md:px-12 bg-white">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-500 mb-16 max-w-3xl mx-auto">
          We help businesses launch reliable cross-platform apps without
...
const IndustriesSection = () => {
  const industries = [
    ...
    },
    {
      ...
      icon: <Briefcase className="text-[#00a8ff]" />,
    },
    {
      title: "FinTech Applications",
      icon: <Shield className="text-[#00a8ff]" />,
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {industries.map((ind, i) => (
            <div
              key={i}
              className="bg-white p-12 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all text-center group"
            >
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        <div>
          ...
          <p className="text-lg text-gray-600 mb-10 leading-relaxed">
            ...
            high-performance cross-platform applications with secure, scalable
            backends.
          </p>
          <div className="flex flex-wrap gap-3">
            {stack.map((item, i) => (
              <span
                key={i}
                className="px-4 py-2 bg-gray-100 rounded-lg text-sm font-bold text-gray-600 border border-gray-200"
              >
                {item}
              </span>
            ))}
  ...
  const faqs = [
    {
      ...
      a: "React Native is a framework developed by Meta that allows developers to build mobile apps using JavaScript and React. It enables a single codebase to run on both iOS and Android with native-like performance.",
    },
    {
      q: "Is React Native suitable for enterprise applications?",
      a: "Yes, React Native is highly suitable for enterprise apps due to its scalability, modular architecture, and strong community support. Many Fortune 500 companies use it for their core mobile products.",
    },
    {
      q: "How does React Native differ from Flutter?",
      a: 'React Native uses JavaScript and bridges to native components, while Flutter uses Dart and its own rendering engine. React Native often feels more "native" in terms of UI components, while Flutter offers more consistent visual control.',
    },
    {
      q: "Do you provide post-launch support?",
      a: "Absolutely. We offer comprehensive maintenance and support packages to ensure your app stays up-to-date with the latest OS versions and continues to perform optimally.",
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl bg-white border border-gray-200 focus:border-[#00a8ff] focus:ring-4 focus:ring-[#00a8ff]/10 outline-none transition-all"
                />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700 ml-1">
