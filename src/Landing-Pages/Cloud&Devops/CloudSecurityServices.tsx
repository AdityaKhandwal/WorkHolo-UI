...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[#7B2CBF]/90 backdrop-blur-md py-2 shadow-lg' : 'bg-transparent py-4'}`}>
      {/* Top Bar */}
      {!isScrolled && (
        <div className="hidden lg:block border-b border-white/10 pb-2 mb-2">
          <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-[11px] font-medium opacity-80">
            <div className="flex items-center gap-6">
              <a href="mailto:contact@mtouchlabs.com" className="flex items-center gap-1.5 hover:text-brand-orange transition-colors">
            ...
            <div className="flex items-center gap-6">
              <span className="text-brand-orange">NASSCOM SME Inspire Awards 2026 🏆</span>
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
            <span className="text-[#7B2CBF] font-bold text-xl">M</span>
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-bold tracking-tight">mTouch Labs</span>
            <span className="text-[8px] uppercase tracking-widest opacity-60">Certified ISO Company</span>
          </div>
        </div>

        <div className="hidden lg:flex items-center gap-8 text-sm font-medium">
          <a href="#" className="flex items-center gap-1 hover:text-brand-orange transition-colors">Home <ChevronDown size={14} /></a>
          <a href="#" className="flex items-center gap-1 text-brand-orange">Services <ChevronDown size={14} /></a>
          <a href="#" className="flex items-center gap-1 hover:text-brand-orange transition-colors">Products <ChevronDown size={14} /></a>
          <a href="#" className="flex items-center gap-1 hover:text-brand-orange transition-colors">Resources <ChevronDown size={14} /></a>
        ...
        <button className="bg-brand-blue hover:bg-blue-500 text-white px-6 py-2.5 rounded-full text-sm font-bold flex items-center gap-2 transition-all shadow-lg hover:shadow-blue-500/20">
...
const Footer = () => {
  return (
    <footer className="bg-black/20 pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center gap-2 mb-8">
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <span className="text-[#7B2CBF] font-bold text-lg">M</span>
              </div>
              <span className="text-lg font-bold">mTouch Labs</span>
            </div>
            ...
            <div className="flex gap-4">
              ...
              {[1,2,3,4].map(i => <div key={i} className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-blue transition-colors cursor-pointer" />)}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              ...
              <li><a href="#" className="hover:text-brand-orange transition-colors">Portfolio</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold uppercase tracking-widest text-xs mb-8">Services</h4>
            <ul className="space-y-4 text-sm text-white/60">
              <li><a href="#" className="hover:text-brand-orange transition-colors">Custom Software Development</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Cloud & DevOps Solutions</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Cyber Security Services</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">AI & Machine Learning</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold uppercase tracking-widest text-xs mb-8">Contact Us</h4>
            <div className="space-y-6 text-sm text-white/60">
              <div className="flex items-start gap-3">
                <MapPin size={18} className="text-brand-blue shrink-0" />
                <span>Plot No. 12, 3rd Floor, Image Gardens Rd, VIP Hills, Silicon Valley, Madhapur, Hyderabad, Telangana 500081</span>
              </div>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[11px] font-medium text-white/40 uppercase tracking-widest">
